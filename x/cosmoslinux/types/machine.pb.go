...
func (m *Machine) GetCommands() []string {
	if m != nil {
		return m.Commands
	}
	return nil
...
var fileDescriptor_b36d932bf17f30cc = []byte{
	...
	0xa5, 0xea, 0x15, 0x14, 0xe5, 0x97, 0xe4, 0x0b, 0x89, 0x23, 0x49, 0xe9, 0x21, 0xb1, 0x95, 0x52,
	...
	0x33, 0x58, 0x08, 0xc2, 0x11, 0x92, 0xe2, 0xe2, 0x48, 0xce, 0xcf, 0xcd, 0x4d, 0xcc, 0x4b, 0x29,
	0x96, 0x60, 0x51, 0x60, 0xd6, 0xe0, 0x0c, 0x82, 0xf3, 0x9d, 0xac, 0x4e, 0x3c, 0x92, 0x63, 0xbc,
	0xf0, 0x48, 0x8e, 0xf1, 0xc1, 0x23, 0x39, 0xc6, 0x09, 0x8f, 0xe5, 0x18, 0x2e, 0x3c, 0x96, 0x63,
	0xb8, 0xf1, 0x58, 0x8e, 0x21, 0x4a, 0x01, 0xe2, 0x1a, 0x5d, 0x88, 0xab, 0x51, 0xfd, 0x50, 0x52,
	0x59, 0x90, 0x5a, 0x9c, 0xc4, 0x06, 0xf6, 0x82, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x64, 0x92,
	0x63, 0xdb, 0xeb, 0x00, 0x00, 0x00,
}
...
func (m *Machine) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Commands) > 0 {
		for iNdEx := len(m.Commands) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintMachine(dAtA, i, uint64(len(m.Commands[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
